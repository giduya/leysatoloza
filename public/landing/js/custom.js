(function($) {
	...
	// table comparation hidden

    $("#h61").mouseover(function(){
        $("#p1").show();
    });
    $("#h61").mouseout(function(){
        $("#p1").hide();
    });
    ...
    $("#h62").mouseover(function(){
        $("#p2").show();
    });
    $("#h62").mouseout(function(){
        $("#p2").hide();
    });
    ...
    $("#h63").mouseover(function(){
        $("#p3").show();
    });
    $("#h63").mouseout(function(){
        $("#p3").hide();
    });
    ...
    $("#h64").mouseover(function(){
        $("#p4").show();
    });
    $("#h64").mouseout(function(){
        $("#p4").hide();
    });
    ...
    $("#h65").mouseover(function(){
        $("#p5").show();
    });
    $("#h65").mouseout(function(){
        $("#p5").hide();
    });
    ...
    $("#h66").mouseover(function(){
        $("#p6").show();
    });
    $("#h66").mouseout(function(){
        $("#p6").hide();
    });
    ...
    iframe: {
        ...
        patterns: {
            youtube: {
                index: 'youtube.com/',
                id: 'v=',
                src: 'https://www.youtube.com/embed/31dEQ3yCZoo'
            }
        }
    }
    // other options
