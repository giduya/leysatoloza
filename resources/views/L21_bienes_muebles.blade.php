                ...
                <form action="{{ url('declaracion/'.$declaracion->id.'/'.Route::current()->parameters()['formato_slug']) }}" method="POST" autocomplete="off">
                  ...
                  <fieldset>
                    <legend>
                      ...
                      <h4 class="mb-3">
                        <label>
                          <input type="checkbox" value="1" name="F12_ninguno" id="F12_ninguno" @if($declaracion->F12_ninguno == 1 or old('F12_ninguno') == 1) checked  @endif>
                          NINGUNO
                        </label>
                      </h4>
                    </legend>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-3">
                        <textarea tabindex="8" class="form-control" id="F12_aclaracionesObservaciones" rows="7" name="F12_aclaracionesObservaciones" placeholder="">@if(old('F12_aclaracionesObservaciones')){{ old('F12_aclaracionesObservaciones') }}@else{{ $declaracion->F12_aclaracionesObservaciones }}@endif</textarea>
