                  ...
                  <form action="{{ url('declaracion/'.$declaracion->id.'/'.Route::current()->parameters()['formato_slug']) }}" method="POST" autocomplete="off">
                    ...
                    <fieldset>
                      <legend>
                        ...
                        <h4 class="mb-3">
                          <label>
                            <input type="hidden" value="0" name="F17_ninguno">
                            <input type="checkbox" value="1" name="F17_ninguno" id="ninguno" @if($declaracion->F17_ninguno == 1 or old('F17_ninguno') == 1) checked  @endif>
                            No participo en decisiones
                          </label>
                        </h4>
                      </legend>
                    ...
                    <div class="table-responsive" id="tabla">
                      <table class="table table-responsive-md">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $fila->F17_tipoInstitucion_valor }}</td>
                            <td>{{ $fila->F17_nombreInstitucion }}</td>
                            <td>
                              <div class="d-flex">
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-3">
                        <textarea tabindex="8" class="form-control" id="aclaracionesObservaciones" rows="7" name="F17_aclaracionesObservaciones" placeholder="">@if(old('F17_aclaracionesObservaciones')){{ old('F17_aclaracionesObservaciones') }}@else{{ $declaracion->F17_aclaracionesObservaciones }}@endif</textarea>
