                ...
                <form action="{{ url('declaracion/'.$declaracion->id.'/'.Route::current()->parameters()['formato_slug']) }}" method="POST" autocomplete="off">
                  ...
                  <fieldset>
                    <legend>
                      ...
                      <h4 class="mb-3">
                        <label>
                          <input type="checkbox" value="1" name="F13_ninguno" id="F13_ninguno" @if($declaracion->F13_ninguno == 1 or old('F13_ninguno') == 1) checked  @endif>
                          NINGUNO
                        </label>
                      </h4>
                    </legend>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-3">
                        <textarea tabindex="8" class="form-control" id="F13_aclaracionesObservaciones" rows="7" name="F13_aclaracionesObservaciones" placeholder="">@if(old('F13_aclaracionesObservaciones')){{ old('F13_aclaracionesObservaciones') }}@else{{ $declaracion->F13_aclaracionesObservaciones }}@endif</textarea>
