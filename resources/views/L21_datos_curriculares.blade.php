                    ...
                    <div class="table-responsive" id="tabla">
                      ...
                      <table class="table table-responsive-md">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $fila->F3_nivel_valor }}</td>
                            <td>{{ $fila->F3_institucionEducativa_nombre }}</td>
                            <td>{{ $fila->F3_estatus }}</td>
                            <td>
                              <div class="d-flex">
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-3">
                        <textarea tabindex="8" class="form-control" id="aclaracionesObservaciones" rows="7" name="F3_aclaracionesObservaciones" placeholder="">@if(old('F3_aclaracionesObservaciones')){{ old('F3_aclaracionesObservaciones') }}@else{{ $declaracion->F3_aclaracionesObservaciones }}@endif</textarea>
