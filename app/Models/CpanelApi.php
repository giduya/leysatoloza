...
class CpanelApi
{
    ...
    //public $server = "ayuntamientodigital.gob.mx";
    public $server = "declarapat.app";
    ...
    public $user = "declarapatgob";
    public $json = '';

    protected $scope; //String - Module we want to use
    protected $api;
    protected $auth;
    protected $pass = "Millon_dolares_400_oneñ";
    protected $secret;
    protected $type;
    protected $session;
    protected $method;
     ...
     * @param $secret
     */
    function __construct($secret = FALSE)
    {
        if ($secret)
        {
            $this->secret = $secret;
